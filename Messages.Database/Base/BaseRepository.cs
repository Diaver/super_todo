...
public abstract class BaseRepository<TEntity> where TEntity : DbEntity
    {
        private readonly IMessageDbContextFactory _dbContextFactory;

        public DbSet<TEntity> Entities { get; set; }

        protected BaseRepository(IMessageDbContextFactory dbContextFactory)
        {
        ...
        {
            await using MessageDbContext dbContext = CreateDbContext();
        ...
        {
            using MessageDbContext dbContext = CreateDbContext();
        ...
        {
            await using MessageDbContext context = CreateDbContext();
